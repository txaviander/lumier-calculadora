...
1. `claude-context/project-context.md` - Contexto técnico del proyecto
2. `claude-context/task-history.md` - Última sesión de trabajo
3. `claude-context/decisions.md` - Decisiones técnicas importantes
